...
def historyCrawl(queryStart1,queryStart2):
    # Define the date format string expected by the input field
    date_format = "%d/%m/%Y"

    # Get user input for the start date
    start_date_input = queryStart1 #input("Enter the start date (DD/MM/YYYY): ")

    # Get user input for the end date
    end_date_input = queryStart2 #input("Enter the end date (DD/MM/YYYY): ")
